...
public class AnimationButton extends View {
     ...
     * view的宽度
     */
    private int width;   //xml android:layout_width="200dp"
    /**
     * view的高度
     */
    private int height;  //xml android:layout_height="50dp"
    /**
     * 圆角半径
     */
    ...
    public AnimationButton(Context context) {
        this(context, null);
        Log.d(TAG, "AnimationButton(Context context)");
    }

    public AnimationButton(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        Log.d(TAG, "AnimationButton(Context context, AttributeSet attrs)");
    }

    public AnimationButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        Log.d(TAG, "AnimationButton(Context context, AttributeSet attrs, int defStyleAttr)");
    ...
    private void initAnimation() {
        set_rect_to_angle_animation();//设置矩形过度到圆角矩形的动画
        set_rect_to_circle_animation();//设置圆角矩形过度到圆的动画
        set_move_to_up_animation();//设置view上移的动画
        set_draw_ok_animation();//绘制对勾的动画
